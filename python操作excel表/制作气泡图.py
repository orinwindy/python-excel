...
df=pd.read_excel('F:\\测试用表格\\气泡图.xlsx')
figure=plt.figure()
...
y=df['利润（万）']
z=df["产品名称"]
plt.scatter(x,y,s=y*100,color='red',marker='o')#制作气泡图
...
workbook=app.books.open('F:\\测试用表格\\气泡图.xlsx')
worksheet=workbook.sheets[0]
worksheet.pictures.add(figure,name='图片1',update=True,left=200)
workbook.save('F:\\测试用表格\\气泡图1.xlsx')
workbook.close()
app.quit()